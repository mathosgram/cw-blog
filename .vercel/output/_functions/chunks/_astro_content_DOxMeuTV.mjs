...
import { z } from "zod";
import { r as removeBase, i as isRemotePath, p as prependForwardSlash } from "./path_CRklIUy-.mjs";
import { V as VALID_INPUT_FORMATS } from "./consts_DUwqJ8kp.mjs";
import { A as AstroError, L as LiveContentConfigError, k as AstroUserError, U as UnknownContentCollectionError, a as createComponent, l as RenderUndefinedEntryError, u as unescapeHTML, g as renderTemplate, n as renderUniqueStylesheet, o as renderScriptElement, p as createHeadAndContent, r as renderComponent } from "./astro/server_Bp3iFUji.mjs";
import "kleur/colors";
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import("./_astro_data-layer-content_KrrRbikq.mjs");
...
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_test_your_publishable_key_here", "PUBLIC_SITE_URL": "https://your-domain.vercel.app", "SITE": "https://stack.cowrywise-ambassadors.com/", "SSR": true };
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import("./_astro_assets_DbSLjSgj.mjs").then((n) => n._);
